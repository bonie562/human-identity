...
function App() {
  ...
  useEffect(() => {
    ...
    document.addEventListener("contextmenu", handleImageContextMenu, false);
    document.addEventListener("dragstart", handleImageDragStart, false);
    document.addEventListener("mousedown", handleImageMouseDown, false);

    return () => {
      document.removeEventListener("contextmenu", handleImageContextMenu, false);
      document.removeEventListener("dragstart", handleImageDragStart, false);
      document.removeEventListener("mousedown", handleImageMouseDown, false);
    };
  }, []);
