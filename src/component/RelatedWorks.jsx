  ...
  return (
    <div className="p-4">
      ...
      <div className="relative">
        ...
        <div
          ref={scrollRef}
          className="flex gap-3 sm:gap-4 md:gap-5 lg:gap-6 overflow-x-auto scroll-smooth scrollbar-hide pr-6"
        >
          {workData.map(({ tag, url, contents }, idx) => {
            ...
            return (
              ...
              >
                <div className="relative w-44 h-32 sm:w-52 sm:h-40 md:w-60 md:h-48 lg:w-72 lg:h-56 xl:w-80 xl:h-64 rounded-md overflow-hidden">
                  <img
                    src={secondImage.img}
                    alt={`related-${idx}`}
                    draggable={false}
