...
import identityImage from "../../img/identity.jpeg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="md:w-2/3 lg:max-w-[45rem] bg-white shadow-md h-10 md:h-12 lg:h-16 rounded-full flex relative">
              ...
              >
                {isLoading ? (
                  ...
                  <img src={SendBtn} alt="Send" draggable={false} className="lg:w-10 lg:h-10" />
                )}
              </button>
            </div>
        ...
        <div className="">
          <img
            ...
            alt="Identity"
            draggable={false}
            className="w-full max-w-[70rem] object-cover"
          />
        </div>
      </div>
