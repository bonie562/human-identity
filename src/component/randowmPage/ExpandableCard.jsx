        ...
        >
          ...
          >
            <img
              ...
              alt=""
              draggable={false}
              className={`w-10 pointer-events-none ${isActive ? "-rotate-90" : "rotate-0"} transition-all duration-300 ease-in-out rounded-full m-0`}
            />
          </button>
        </div>
      </div>
        ...
        {isActive && (
          ...
          >
            {type === "random" && contents ? (
              ...
              subItems.map(({ id, label, videoSrc }, index) => (
                <SkillSet
                  key={index}
                  id={id}
                  label={label}
